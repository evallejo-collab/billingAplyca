              ...
              {showSupportRecurrentPayments && (
                <div className="p-8 bg-gray-50">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white border border-gray-200 p-6">
                      <h3 className="text-base font-medium text-gray-900 mb-4">Pago de Soporte Recurrente</h3>
                      <div className="h-64">
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart data={(() => {
                ...
                <div className="mt-8 bg-white border border-gray-200">
                  <div className="px-6 py-4 border-b border-gray-200">
                    <button
                      ...
                      className="flex items-center justify-between w-full text-left"
                    >
                      <h4 className="text-base font-medium text-gray-900">Detalle de Pagos de Soporte y Evolutivos</h4>
                      {showPaymentDetails ? (
                        <ChevronUp className="h-5 w-5 text-gray-500" />
                      ) : (
                        <ChevronDown className="h-5 w-5 text-gray-500" />
                  ...
                  {showPaymentDetails && (
                    <div className="overflow-x-auto">
                      <table className="w-full">
                        ...
                        <tbody className="divide-y divide-gray-100">
                          {summary.supportAndDevelopmentPayments.map((payment, index) => (
                            <tr key={payment.id || index} className="hover:bg-blue-50 bg-white border-b border-gray-200">
                              <td className="px-6 py-4 text-sm text-gray-900 font-semibold">
                                {new Date(payment.payment_date).toLocaleDateString('es-ES')}
                              </td>
