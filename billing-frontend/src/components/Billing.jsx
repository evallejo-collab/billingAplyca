                    ...
                    <div key={item.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                      <div className="flex items-center space-x-4 flex-1">
                        ...
                        <div className="flex items-center space-x-6">
                          <div className="text-right">
                            <div className="text-sm font-bold text-gray-900">{formatCurrency(item.totalValue, true)}</div>
                            <div className="text-xs text-gray-600">Total</div>
                          </div>
                          <div className="text-right">
                            <div className="text-sm font-bold text-gray-900">{formatCurrency(item.paidAmount, true)}</div>
                      ...
                      <div className="flex items-center space-x-2 ml-4">
                        <button
                          ...
                          className="text-blue-600 hover:text-blue-700 py-1 px-2 text-sm font-medium transition-colors duration-200 flex items-center"
                        >
                        ...
                        <button
                          ...
                          className="text-green-600 hover:text-green-700 py-1 px-2 text-sm font-medium transition-colors duration-200 flex items-center"
                        >
