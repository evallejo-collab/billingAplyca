                    ...
                    <div key={item.id} className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                      <div className="flex items-center space-x-4 flex-1 min-w-0">
                        ...
                        <div className="flex items-center space-x-6 flex-shrink-0">
                          <div className="text-right">
                            <div className="text-sm font-bold text-gray-900 whitespace-nowrap">{formatCurrency(item.totalValue, true)}</div>
                            <div className="text-xs text-gray-600">Total</div>
                          </div>
                          <div className="text-right">
                            <div className="text-sm font-bold text-gray-900 whitespace-nowrap">{formatCurrency(item.paidAmount, true)}</div>
                            <div className="text-xs text-gray-600">Pagado</div>
                          </div>
                          <div className="text-right min-w-16">
                            <div className="text-sm font-bold text-gray-900">{item.paymentPercentage.toFixed(1)}%</div>
                            <div className="w-16 bg-gray-200 rounded-sm h-1.5 mt-1">
                              <div 
                                className="bg-blue-600 h-1.5 rounded-sm transition-all duration-300"
                      ...
                      <div className="flex items-center space-x-2 ml-4 flex-shrink-0">
                        <button
                          ...
                          className="text-blue-600 hover:text-blue-700 py-1 px-1 text-xs transition-colors duration-200 flex items-center whitespace-nowrap"
                        >
                        ...
                        <button
                          ...
                          className="text-green-600 hover:text-green-700 py-1 px-1 text-xs transition-colors duration-200 flex items-center whitespace-nowrap"
                        >
